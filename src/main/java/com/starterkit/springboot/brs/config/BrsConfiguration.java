...
public class BrsConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Transportation Reservation System - REST APIs")
                .description("Transportation Reservation System Using Java Spring Boot.").termsOfServiceUrl("")
                .contact(new Contact("Kelompok 3", "", "farrelmuhammad0410@gmail.com"))
